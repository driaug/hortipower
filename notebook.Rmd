...
```{r}
#making a corilation matrix
test <- data %>% select(kastemperatuurklimaat, CO2, luwezijderaamstand)

cormat <- round(cor(test),2)
#You can see the matrix with cormat
#reforming the data so it can be used in a heatmap

test <- as.data.frame(matrix(cormat))
test
#showing the corrilation heatmap
